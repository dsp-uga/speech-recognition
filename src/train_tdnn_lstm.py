...
def TDNN_LSTM(input_dim, output_dim=29):
    ...
    time_dense1 = TimeDistributed(Dense(250))(input_data)
    ...
    lstm1 = LSTM(180, activation='tanh',return_sequences=True)(bn_td1)
    
    time_dense4 = TimeDistributed(Dense(160))(lstm1)
    ...
    time_dense8 = TimeDistributed(Dense(50))(lstm3)
    time_dense = TimeDistributed(Dense(output_dim))(time_dense8)
...
train_model(input_to_softmax=model, 
            pickle_path='model_lstm_long_0425.pickle', 
            save_model_path='model_lstm_long_0425.h5', spectrogram=True,
            epochs=50)
